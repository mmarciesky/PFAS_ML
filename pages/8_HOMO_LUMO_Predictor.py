...
st.caption("Model version: v0.1 (Preliminary) -- closed-shell gaps only; predictions are solvent-specific")

col1, col2 = st.columns([3, 1])
with col1:
    st.title("PFAS HOMO-LUMO Gap Predictor")
